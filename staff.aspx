<%@ Page Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="staff.aspx.cs" Inherits="staff" Title="Untitled Page" %>
...
<h1>Staff Login</h1>
<form>
<asp:TextBox ID="TextBox1" runat="server" placeholder="Username" ValidationGroup="admin"></asp:TextBox>
...
<asp:Button ID="Button2" runat="server" Text="Register" OnClick="Button2_Click1"/>
